...
# Form implementation generated from reading ui file 'create_res.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Cоздание резюме"))
        self.label_3.setText(_translate("Form", "Должность"))
        self.label_2.setText(_translate("Form", "Зарплата"))
        self.label_4.setText(_translate("Form", "Город"))
        self.label_5.setText(_translate("Form", "Описание"))
        self.label_6.setText(_translate("Form", "Путь к фото"))
